...
const RESOURCES: ResourceDef[] = [
  {
    name: "course",
    uri: "scp-golf://course/demo",
    description: "The demo course profile.",
    load: getCourse,
  },
  {
    name: "context",
    uri: "scp-golf://course/demo/context",
    description:
